...
\begin{table}[htb!]
	...
	\begin{tabular}{p{4cm} p{11cm}}
		...
		\textbf{Caractere}				& O valor é o equivalente em código ascii do caractere \\
...
\begin{enumerate}
	\item Verifica se o último caractere é de espaço em branco (\emph{whitespace}). Se for, lê o próximo até achar um que não seja.
	\item Verifica se o último caractere é o marcador de fim de arquivo. Se sim, retorna o token de EOF.
	\item Pede a todos os autômatos para processarem o caractere. Aqueles que retornarem ``falso'' são marcados como autômatos desabilitados para o próximo caractere.
	\item Lê o próximo caractere.
	\item Aos autômatos restantes, oferece o caractere para processamento.
	...
	\item Se o último autômato não estiver em um estado final, isso caracteriza um estado de erro. O analisador sintático pára o processo -- por exemplo, na presença de um caractere que não seja ASCII no nome de um identificador.
\end{enumerate}
