...
\subsection{Ações}
Uma ação semântica é executada quando o ocorre a transição a que ela está associada. Por necessidade, cada autômato, pode ter uma ação final, que é executada apenas quando este retorna para outro autômato.
...
Ação semântica que associa uma nova \emph{label} à variável criada.
